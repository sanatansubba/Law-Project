                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Please Enter Banner Title" name="title" id="title" value="{{ old('title') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Please Enter Banner Sub Title" name="subtitle" id="subtitle" value="{{ old('subtitle') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Please Enter Banner Link" name="link" id="link" value="{{ old('link') }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Please Enter Banner Priority" name="priority" id="priority" value="{{ old('priority') }}">
                                        </div>
                                    </div>
