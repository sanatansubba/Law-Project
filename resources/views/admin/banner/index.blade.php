            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto text-right">
                        <a href="{{ route('banner.add') }}" class="btn btn-primary add-button" style="color: white"><i class="feather-plus"></i> </a>
                    </div>
                </div>
            </div>
            ...
            columns: [
                ...
                {data: 'image', name: 'image',
                    render: function (data, type, full, meta){
                        if(data){
                            return "<img src={{ URL::to('/') }}/public/uploads/banner/" + data + " width='200' >";
                        }
