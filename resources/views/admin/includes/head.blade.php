...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/backend/assets/plugins/simple-calendar/simple-calendar.css') }}">

    <link rel="stylesheet" href="{{ asset('public/backend/assets/css/feather.css') }}">

    <link rel="stylesheet" href="{{ asset('public/backend/assets/plugins/datatables/datatables.min.css') }}">
