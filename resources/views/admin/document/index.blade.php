...
@section('title') Downloads Management - {{ config('app.name', 'Laravel') }} @endsection
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto text-right">
                        <a href="{{ route('document.add') }}" class="btn btn-primary add-button" style="color: white"><i class="feather-plus"></i> </a>
                    </div>
                </div>
            </div>
