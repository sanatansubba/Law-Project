                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Please Enter  Title" name="title" id="title" value="{{ $document->title }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" placeholder="Please Enter File" name="document" id="image">
                                        </div>

                                        <a href="{{ url($document->document) }}" class="btn btn-sm btn-info" target="_blank">View File</a>
                                    ...
                                    <div class="col-md-12">
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-success text-center">Update Document</button>
                                        </div>
                                    </div>
