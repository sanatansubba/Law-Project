                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Please Enter Name" name="name" id="name" value="{{ $testimonial->name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Please Enter Position" name="position" id="position" value="{{ $testimonial->position }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12" style="margin-bottom: 20px">
                                            <img src="{{ asset('public/uploads/testimonial/'.$testimonial->image)  }}" alt="" id="one" width="200px">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="text-right">
                                            <button type="submit" class="btn btn-success text-center">Update Testimonial</button>
                                        </div>
                                    </div>
