...
<?php $__env->startSection('content'); ?>
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <form action="<?php echo e(route('lawyer.store')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" placeholder="Please Enter Email" name="email" id="email" value="<?php echo e(old('email')); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Please Enter Mobile Number" name="mobile" id="mobile" value="<?php echo e(old('mobile')); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Please Enter Address" name="address" id="address" value="<?php echo e(old('address')); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Please Enter Speciality" name="speciality" id="speciality" value="<?php echo e(old('speciality')); ?>">
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.includes.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lawproject\resources\views/admin/lawyer/add.blade.php ENDPATH**/ ?>