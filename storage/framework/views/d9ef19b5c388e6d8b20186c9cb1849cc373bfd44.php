...
<?php $__env->startSection('title'); ?> Social Media Settings - <?php echo e(config('app.name', 'Laravel')); ?> <?php $__env->stopSection(); ?>
                ...
                <div class="col-xl-9 col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="<?php echo e(route('socialUpdate')); ?>" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row form-group">
                                    <label for="facebook" class="col-sm-3 col-form-label input-label">Facebook</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="facebook" id="facebook" value="<?php echo e($social->facebook); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="instagram" id="instagram" value="<?php echo e($social->instagram); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="youtube" id="youtube" value="<?php echo e($social->youtube); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="linkedin" id="linkedin" value="<?php echo e($social->linkedin); ?>">
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.includes.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lawproject\resources\views/admin/theme/social.blade.php ENDPATH**/ ?>