            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto text-right">
                        <a href="<?php echo e(route('blog.add')); ?>" class="btn btn-primary add-button" style="color: white"><i class="feather-plus"></i> </a>
                    </div>
                </div>
            </div>
...
<?php $__env->startSection('js'); ?>
    <script>
        $('#type-datatable').DataTable({
            ...
            searchable: true,
            responsive: true,
            ajax: "<?php echo e(route('table.blog')); ?>",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'image', name: 'image',
                    render: function (data, type, full, meta){
                        if(data){
                            return "<img src=<?php echo e(URL::to('/')); ?>/public/uploads/blog/" + data + " width='200' >";
                        }
...
<?php echo $__env->make('admin.includes.admin_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lawproject\resources\views/admin/blog/index.blade.php ENDPATH**/ ?>