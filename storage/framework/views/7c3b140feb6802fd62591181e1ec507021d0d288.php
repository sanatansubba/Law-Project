...
<?php $__env->startSection('site_title'); ?>
  Blogs Page for <?php echo e($category->category_name); ?>
            ...
            <div class="item">
                <div class="bread" style="height: 40vh">
                    ...
                    <div class="breadcrumb-section">
                        <h1>Blogs</h1>
                        <span>Home <i class="fas fa-chevron-right"></i> <a href="#"><?php echo e($category->category_name); ?></a></span>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div style="padding: 20px;">
                            <h2>No Blogs Found for <?php echo e($category->category_name); ?></h2>
                        </div>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('front.includes.front_design', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lawproject\resources\views/front/blogCategory.blade.php ENDPATH**/ ?>